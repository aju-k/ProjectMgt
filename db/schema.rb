...
ActiveRecord::Schema.define(version: 20170826125248) do
  ...
  add_index "project_developers", ["project_id"], name: "index_project_developers_on_project_id"
  add_index "project_developers", ["user_id"], name: "index_project_developers_on_user_id"
